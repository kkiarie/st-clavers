    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
             ...
             <a href="{{ URL::to("/setup") }}" >
            <button class="btn btn-primary mt-4"><i class="fa fa-chevron-left"></i>Back</button>
          </a>
        ...
        <button onclick="return confirm('Are you sure?')" class="btn btn-danger mt-2"><i class="far fa-trash-alt"></i> Delete {{$Setup->title}}</button>
        </form>
