            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">All Subject Clusters</h5>
                        </div>
                        <a href="{{ URL::to("/subject-clusters/create/0") }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Cluster</a>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0 table-striped">
                            ...
                            <tbody>
                                ...
                                @foreach ($SubjecClusters as $item)
                                <tr>
                                    <td class="ps-4">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ URL::to("/subject-clusters/create/".$item->id) }}" >
            <button class="btn btn-primary "><i class="far fa-eye"></i> View </button>
          </a>



          <a href="{{ URL::to("/subject-clusters/".$item->id."/edit") }}" >
