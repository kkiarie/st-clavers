        ...
        <div class="col-12">
          ...
          <a href="{{ URL::to("/program-subject/create/$Program->id") }}" >
            <button class="btn btn-success mt-4"><i class="fas fa-plus"></i> New Program Unit </button>
                    ...
                    <a target="_blank" href="{{ URL::to("/program-pdf/$Program->id") }}" >
            <button class="btn btn-primary mt-4"><i class="fas fa-file-pdf"></i> PDF </button>
          </a>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" scope="col"  data-sort="budget">@sortablelink('program_unit_id','Program Unit')
                                     ...
                                     <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" scope="col"  data-sort="budget">@sortablelink('academic_level','Year')
...
{{$item->ProgamUnitData->title}}
                                    ...
                                    <td class="text-center">
                                     ...
                                     <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{$item->ProgamYear->title}}</p>
                                    </td>
