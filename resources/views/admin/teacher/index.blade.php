...
<div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ URL::to("/teachers/create") }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Teachers</a>

                         <a href="{{ URL::to("/teachers-import") }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; Import Teachers</a>
                    </div>
                </div>
                @include('layouts.feedback')
            <div style="padding:10px">
                
              <form action="{{action('App\Http\Controllers\Admin\TeacherController@teachersQuery')}}" method="POST">
                {{ csrf_field() }}
                <div class="row">
            ...
            <label class="form-control-label" for="input-client_id">{{ __('Teachers') }}</label>
            <br/>
               <select  name="value" 
                        ...
                        <table class="table align-items-center mb-0 table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" scope="col"  data-sort="budget">@sortablelink('name','Teachers Name')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ URL::to("/teachers/".$item->id."/edit") }}" >
