            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">All Class Teachers</h5>
                        </div>
                        <a href="{{ URL::to("/class-teachers/create") }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Class Teacher</a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0 table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" scope="col"  data-sort="budget">@sortablelink('academic_year','Academice Year ')
...
<p class="text-xs font-weight-bold mb-0">{{$item->academic_year}}</p>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ URL::to("/class-teachers/".$item->id."/edit") }}" >
            <button class="btn btn-primary "><i class="fa-solid fa-pen-to-square"></i> Edit </button>
          </a>



          <form action="{{action('App\Http\Controllers\Admin\ClassTeacherController@destroy', $item->id)}}" method="POST" role="form">
            {{ csrf_field() }}
