...
if(isset($ClassTeacher)&&$ClassTeacher->class_id==$item->id):
...
if(isset($ClassTeacher)&&$ClassTeacher->stream_id==$item->id):
...
if(isset($ClassTeacher)&&$ClassTeacher->teacher_id==$item->id):
...
<form method="post" action="{{ route('class-teachers.store')}}" enctype="multipart/form-data">
@else
<form action="{{action('App\Http\Controllers\Admin\ClassTeacherController@update', $id)}}" method="POST" enctype="multipart/form-data">
