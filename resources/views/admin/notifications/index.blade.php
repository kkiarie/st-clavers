...
<div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{ URL::to("/notification/create") }}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Notification</a>
                    </div>
                </div>
                @include('layouts.feedback')
            <div style="padding:10px">
                
              <form action="{{action('App\Http\Controllers\Admin\NotificationController@notificationQuery')}}" method="POST">
                {{ csrf_field() }}
                <div class="row">
            ...
            <label class="form-control-label" for="input-client_id">{{ __('Notification') }}</label>
            <br/>
               <select  name="value" 
                        ...
                        <table class="table align-items-center mb-0 table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" scope="col"  data-sort="budget">@sortablelink('title','Notification Title')
                                       
                                    </th>

                                         <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" scope="col"  data-sort="budget">@sortablelink('user_role','Group')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ URL::to("/notification/".$item->id."/edit") }}" >
