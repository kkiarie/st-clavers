...
<form action="{{action('App\Http\Controllers\Admin\ExpenseController@expenseReportProc')}}" method="POST" target="_blank">
...
<div class="col-xs-12 col-sm-6">
            ...
            <label class="form-control-label" for="input-ledger_code_id">{{ __('Ledgers') }}</label>
            <br/>
               <select <?php if(isset($MotorPrivate)) { echo "disabled";} ?> name="ledger_code_id" 
